...
- 1 [Introduction to Jest and React](#introduction-to-jest-and-react)
- 2 [Naming and Location Conventions for Test Files](#naming-and-location-conventions-for-test-files)
- 3 [Folder structure](#folder-structure)
- 4 [Ways to Start Testing in Jest](#ways-to-start-testing-in-jest)
- 5 [Defining and Testing Components](#defining-and-testing-components)
  - 5.1 [Defining a Component](#defining-a-component)
  - 5.2 [Writing Tests for a Component](#writing-tests-for-a-component)
- 6 [Testing Techniques](#testing-techniques)
- 7 [Selecting Elements By Role](#selecting-elements-by-role)
  - 7.1 [Accessible Names](#accessible-names)
    - 7.1.1 [Selecting By Accessible Name](#selecting-by-accessible-name)
  - 7.2 [Accessible Names for Inputs](#accessible-names-for-inputs)
  - 7.3 [Applying a Name to Other Elements](#applying-a-name-to-other-elements)
- 8 [Query Functions](#query-functions)
  - 8.1 [Looking for a Single Element?](#looking-for-a-single-element)
  - 8.2 [Looking for Multiple Elements?](#looking-for-multiple-elements)
  - 8.3 [When to use each](#when-to-use-each)
- 9 [Querying for Elements With Different Criteria](#querying-for-elements-with-different-criteria)
  - 9.1 [When to Use Each](#when-to-use-each-1)
- 10 [Matchers](#matchers)
  - 10.1 [Custom Matchers](#custom-matchers)
    - 10.1.1 [Example of Custom Matcher](#example-of-custom-matcher)
- 11 [Why the fallback test-id is not recommended](#why-the-fallback-test-id-is-not-recommended)
  - 11.1 [Alternatives to the fallback test-id](#alternatives-to-the-fallback-test-id)
- 12 [Why Label Should Be Related to htmlFor and an id in Unit Tests](#why-label-should-be-related-to-htmlfor-and-an-id-in-unit-tests)
- 13 [Why Use Regular Expressions in Jest and React Testing Library Unit Tests](#why-use-regular-expressions-in-jest-and-react-testing-library-unit-tests)
- 14 [Creating Mocks](#creating-mocks)
  - 14.1 [Manual Mocks](#manual-mocks)
  - 14.2 [Automatic Mocks](#automatic-mocks)
- 15 [Testing GraphQL APIs](#testing-graphql-apis)
  - 15.1 [Setting up the Test Environment](#setting-up-the-test-environment)
  - 15.2 [Testing Queries](#testing-queries)
  - 15.3 [Testing Mutations](#testing-mutations)
  - 15.4 [Creating Mocks](#creating-mocks-1)
  - 15.5 [Conclusion](#conclusion)
- 16 [Mocking External Dependencies](#mocking-external-dependencies) 
  - 16.1 [Why Mock External Dependencies?](#why-mock-external-dependencies)
  - 16.2 [Mocking Modules with Jest](#mocking-modules-with-jest)
  - 16.3 [Mocking API Calls](#mocking-api-calls)
- 17 [Best Practices for Jest Testing](sert-testing#best-practices-for-jest-testing)
  - 17.1 [Writing Readable and Maintainable Tests](#writing-readable-and-maintainable-tests)
  - 17.2 [Organizing Test Files and Folders](sert-testing#organizing-test-files-and-folders)
  - 17.3 [Writing Testable Code](#writing-testable-code)
  - 17.4 [Running Tests Frequently](#running-tests-frequently)
- 18 [Licence](#license)
