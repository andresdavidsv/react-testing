...
- 1 [Introduction to Jest and React](usert-testing#introduction-to-jest-and-react)
- 2 [Naming and Location Conventions for Test Files](usert-testing#naming-and-location-conventions-for-test-files)
- 3 [Folder structure](usert-testing#folder-structure)
- 4 [Ways to Start Testing in Jest](usert-testing#ways-to-start-testing-in-jest)
- 5 [Defining and Testing Components](usert-testing#defining-and-testing-components)
  - 5.1 [Defining a Component](usert-testing#defining-a-component)
  - 5.2 [Writing Tests for a Component](usert-testing#writing-tests-for-a-component)
- 6 [Testing Techniques](usert-testing#testing-techniques)
- 7 [Selecting Elements By Role](usert-testing#selecting-elements-by-role)
  - 7.1 [Accessible Names](usert-testing#accessible-names)
    - 7.1.1 [Selecting By Accessible Name](usert-testing#selecting-by-accessible-name)
  - 7.2 [Accessible Names for Inputs](usert-testing#accessible-names-for-inputs)
  - 7.3 [Applying a Name to Other Elements](usert-testing#applying-a-name-to-other-elements)
- 8 [Query Functions](usert-testing#query-functions)
  - 8.1 [Looking for a Single Element?](usert-testing#looking-for-a-single-element)
  - 8.2 [Looking for Multiple Elements?](usert-testing#looking-for-multiple-elements)
  - 8.3 [When to use each](usert-testing#when-to-use-each)
- 9 [Querying for Elements With Different Criteria](usert-testing#querying-for-elements-with-different-criteria)
  - 9.1 [When to Use Each](usert-testing#when-to-use-each-1)
- 10 [Matchers](usert-testing#matchers)
  - 10.1 [Custom Matchers](usert-testing#custom-matchers)
    - 10.1.1 [Example of Custom Matcher](usert-testing#example-of-custom-matcher)
- 11 [Why the fallback test-id is not recommended](usert-testing#why-the-fallback-test-id-is-not-recommended)
  - 11.1 [Alternatives to the fallback test-id](usert-testing#alternatives-to-the-fallback-test-id)
- 12 [Why Label Should Be Related to htmlFor and an id in Unit Tests](usert-testing#why-label-should-be-related-to-htmlfor-and-an-id-in-unit-tests)
- 13 [Why Use Regular Expressions in Jest and React Testing Library Unit Tests](usert-testing#why-use-regular-expressions-in-jest-and-react-testing-library-unit-tests)
- 14 [Creating Mocks](usert-testing#creating-mocks)
  - 14.1 [Manual Mocks](usert-testing#manual-mocks)
  - 14.2 [Automatic Mocks](usert-testing#automatic-mocks)
- 15 [Testing GraphQL APIs](usert-testing#testing-graphql-apis)
  - 15.1 [Setting up the Test Environment](usert-testing#setting-up-the-test-environment)
  - 15.2 [Testing Queries](usert-testing#testing-queries)
  - 15.3 [Testing Mutations](usert-testing#testing-mutations)
  - 15.4 [Creating Mocks](usert-testing#creating-mocks-1)
  - 15.5 [Conclusion](usert-testing#conclusion)
- 16 [Mocking External Dependencies](usert-testing#mocking-external-dependencies) 
  - 16.1 [Why Mock External Dependencies?](usert-testing#why-mock-external-dependencies)
  - 16.2 [Mocking Modules with Jest](usert-testing#mocking-modules-with-jest)
  - 16.3 [Mocking API Calls](usert-testing#mocking-api-calls)
- 17 [Best Practices for Jest Testing](sert-testing#best-practices-for-jest-testing)
  - 17.1 [Writing Readable and Maintainable Tests](usert-testing#writing-readable-and-maintainable-tests)
  - 17.2 [Organizing Test Files and Folders](sert-testing#organizing-test-files-and-folders)
  - 17.3 [Writing Testable Code](usert-testing#writing-testable-code)
  - 17.4 [Running Tests Frequently](usert-testing#running-tests-frequently)
- 18 [Licence](usert-testing#license)
